...
class CostsControllerTest < ActionController::TestCase
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post :create, cost: { estimated_cost: @cost.estimated_cost, from_distrit_id: @cost.from_distrit_id, to_distrit_id: @cost.to_distrit_id }
    end
  ...
  test "should update cost" do
    patch :update, id: @cost, cost: { estimated_cost: @cost.estimated_cost, from_distrit_id: @cost.from_distrit_id, to_distrit_id: @cost.to_distrit_id }
    assert_redirected_to cost_path(assigns(:cost))
  end
