...
class CostsControllerTest < ActionController::TestCase
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post :create, cost: { estimated_cost: @cost.estimated_cost, from_district_id: @cost.from_district_id, to_district_id: @cost.to_district_id }
    end
  ...
  test "should update cost" do
    patch :update, id: @cost, cost: { estimated_cost: @cost.estimated_cost, from_district_id: @cost.from_district_id, to_district_id: @cost.to_district_id }
    assert_redirected_to cost_path(assigns(:cost))
  end
